  ...
  return (
    <div className="pt-[56px] mx-auto max-w-[1200px] px-4 bg-[#f6f0e7] min-h-screen">
      <div className="flex justify-center items-start pt-20 pb-20">
        <div className="text-black px-10 py-8 rounded-[8px] min-w-[350px] w-full max-w-3xl">

          <h2 className="text-[#6D3811] text-2xl font-bold text-center mb-6">
            My Reservations
          </h2>
          ...
          {!user ? (
            ...
            <div>
              ...
              <p className="text-center text-[#6D3811]/75 p-none">You have no reservations 😱</p>
            </div>
          ) : (
