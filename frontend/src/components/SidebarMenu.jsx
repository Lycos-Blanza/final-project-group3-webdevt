    ...
    <div className="flex flex-col items-start py-6">
      ...
      <div className="flex items-center gap-3 mb-5 w-full cursor-pointer hover:bg-[#000]/20 p-2 rounded-md" onClick={() => { navigate("/profile"); onClose?.(); }}>
        ...
        <div className="flex-1">
          <div className="text-[#6D3811] text-[1.1em] font-bold truncate">
            {user?.name || user?.email}
          </div>
          <div className="text-xs text-[#6D3811]"><p className="m-0">{user?.role} • click here to edit</p></div>
        </div>
      </div>
      ...
      <ul className="list-none p-0 m-0 mb-4 w-full gap-1 flex flex-col">
        {user?.role === "admin" ? (
          <>
            <li>
              <SidebarButton onClick={handleHomeClick} isActive={currentPath === "/"}>
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/dashboard"); onClose?.(); }} isActive={currentPath === "/dashboard"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-speedometer" viewBox="0 0 16 16">
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/messages"); onClose?.(); }} isActive={currentPath === "/messages"}>
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/admin-tables"); onClose?.(); }} isActive={currentPath === "/admin-tables"}>
            ...
            {/* MENU BUTTON - ADDED */}
            <li>
              <SidebarButton onClick={() => { navigate("/menu"); onClose?.(); }} isActive={currentPath === "/menu"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-fork-knife" viewBox="0 0 16 16">
          ...
          <>
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/my-reservations"); onClose?.(); }} isActive={currentPath === "/my-reservations"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-speedometer" viewBox="0 0 16 16">
                  <path d="M8 2a.5.5 0 0 1 .5.5V4a.5.5 0 0 1-1 0V2.5A.5.5 0 0 1 8 2M3.732 3.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707M2 8a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8m9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5m.754-4.246a.39.39 0 0 0-.527-.02L7.547 7.31A.91.91 0 1 0 8.85 8.569l3.434-4.297a.39.39 0 0 0-.029-.518z" />
                  <path fillRule="evenodd" d="M6.664 15.889A8 8 0 1 1 9.336.11a8 8 0 0 1-2.672 15.78zm-4.665-4.283A11.95 11.95 0 0 1 8 10c2.186 0 4.236.585 6.001 1.606a7 7 0 1 0-12.002 0" />
                </svg>
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/my-history"); onClose?.(); }} isActive={currentPath === "/my-history"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-hourglass-bottom" viewBox="0 0 16 16">
            ...
            <li>
              <SidebarButton onClick={() => { navigate("/contact-us"); onClose?.(); }} isActive={currentPath === "/contact-us"}>
